...
async function bootstrap() {
  ...
  // Allow requests from frontend running on port 5173, 5174, or 5175
  app.enableCors({
    origin: [
      'http://localhost:5173',
      'http://localhost:5174',
  ...
  // Increase request body size limits so product payloads with base64 images can be accepted
