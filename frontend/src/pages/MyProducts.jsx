    ...
    return (
      <div className="min-h-screen bg-slate-50 py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-4xl font-bold text-slate-900 mb-8">My Products</h1>
          <div className="rounded-3xl border border-slate-200 bg-white p-12 text-center">
            <div className="text-6xl mb-4">🏪</div>
            <h3 className="text-2xl font-bold text-slate-900 mb-2">No Stores Yet</h3>
            <p className="text-slate-600 mb-6">You need to create a store first before adding products.</p>
            <a
              href="/my-stores"
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-slate-600 mt-2">Manage your product inventory and pricing</p>
          </div>
          {!showForm && (
                  ...
                  {product.images && product.images.length > 0 ? (
                    <img 
                      ...
                      onError={(e) => {
                        ...
                        e.target.parentElement.innerHTML = '<svg class="h-20 w-20 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" /></svg>';
                      }}
                    />
                  ) : (
